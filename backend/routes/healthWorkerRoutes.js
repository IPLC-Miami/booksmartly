...
router.post("/healthCampRegistration", placeholderResponse);
router.post("/healthcheckups", placeholderResponse);
router.get("/healthcamps", placeholderResponse);
router.get("/healthcamps/:id", placeholderResponse);
router.post("/clinician-volunteer", placeholderResponse);
router.get("/clinician/volunteered/:clinicianId", placeholderResponse);
