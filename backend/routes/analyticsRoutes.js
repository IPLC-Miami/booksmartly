...
router.get("/appointments-per-clinician", placeholderResponse);
router.get("/revenue", placeholderResponse);
router.get("/patient-demographics", placeholderResponse);
router.get("/appointment-trends", placeholderResponse);
router.get("/dashboard-summary", placeholderResponse);
