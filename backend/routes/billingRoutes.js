...
router.post("/create-invoice", placeholderResponse);
router.post("/create-session", placeholderResponse);
router.get("/clinician/:clinicianId", placeholderResponse);
router.get("/all", placeholderResponse);
router.put("/update-status/:invoiceId", placeholderResponse);
router.post("/webhook", placeholderResponse);
