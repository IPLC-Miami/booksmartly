...
Call log:
  - waiting for locator('text=Book Appointment')
    - locator resolved to <button data-accent-color="iris" data-testid="book-appointment-button" class="rt-reset rt-BaseButton rt-r-size-3 rt-variant-solid rt-Button font-semibold">Book Appointment</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div class="fixed left-0 top-0 z-50 flex h-screen w-full items-center justify-center bg-[#2121216c] backdrop-blur-sm">…</div> from <div dir="ltr" class="rt-TabsRoot" data-orientation="horizontal">…</div> subtree intercepts pointer events
