...
- Name: Admin Schedule Management >> can create a new schedule
- Location: c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\admin-schedule.spec.cjs:59:3
...
Call log:
  - waiting for button:has-text("Add"), button:has-text("Create"), text=Add Schedule, text=Create Schedule >> nth=0
    ...
    at c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\admin-schedule.spec.cjs:64:21
```
