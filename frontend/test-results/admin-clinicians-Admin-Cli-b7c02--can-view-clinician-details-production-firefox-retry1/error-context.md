...
- Name: Admin Clinician Management >> can view clinician details
- Location: c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\admin-clinicians.spec.cjs:89:3
...
Call log:
  - waiting for locator('text=Clinician, text=Doctor, text=Staff') to be visible
    ...
    at c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\admin-clinicians.spec.cjs:90:11
```
