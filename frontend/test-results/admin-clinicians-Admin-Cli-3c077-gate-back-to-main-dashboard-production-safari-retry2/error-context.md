...
- Name: Admin Clinician Management >> can navigate back to main dashboard
- Location: c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\admin-clinicians.spec.cjs:133:3
...
Call log:
  - waiting for locator('text=Clinician, text=Doctor, text=Staff') to be visible
    ...
    at c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\admin-clinicians.spec.cjs:134:11
```
