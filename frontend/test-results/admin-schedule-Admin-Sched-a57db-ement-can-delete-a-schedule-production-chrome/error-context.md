...
- Name: Admin Schedule Management >> can delete a schedule
- Location: c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\admin-schedule.spec.cjs:139:3

# Error details

```
Error: locator.isVisible: Unexpected token "=" while parsing css selector "button:has-text("Delete"), text=Delete, .delete-button, [data-testid="delete-schedule"]". Did you mean to CSS.escape it?
Call log:
    - checking visibility of button:has-text("Delete"), text=Delete, .delete-button, [data-testid="delete-schedule"] >> nth=0

    at c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\admin-schedule.spec.cjs:148:28
```
