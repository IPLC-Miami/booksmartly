...
Received string:  "https://booksmartly.iplcmiami.com/login"
Call log:
  - expect.toHaveURL with timeout 5000ms
  - waiting for locator(':root')
    8 × locator resolved to <html lang="en" class="lenis">…</html>
      - unexpected value "https://booksmartly.iplcmiami.com/login"

    at c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\booking-flow.spec.cjs:23:24
```
...
- main:
  ...
  - paragraph:
    ...
    - link "create a new account":
      - /url: /signup
  - text: Email address
  - textbox "Email address": client@booksmartly.com
  - text: Password
  - textbox "Password": ClientPass123!
  - button:
    - img
