...
- Name: Admin Clinician Management >> can search and filter clinicians
- Location: c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\admin-clinicians.spec.cjs:64:3
...
Call log:
  - waiting for locator('text=Clinician, text=Doctor, text=Staff') to be visible
    ...
    at c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\admin-clinicians.spec.cjs:65:11
```
...
- main:
  ...
  - tabpanel "Profile":
    ...
    - img
    - text: Friday, June 13, 2025 at 10:41 PM
    - img
