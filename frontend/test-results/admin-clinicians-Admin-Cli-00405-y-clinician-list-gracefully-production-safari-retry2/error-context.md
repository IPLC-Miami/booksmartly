...
- Name: Admin Clinician Management >> handles empty clinician list gracefully
- Location: c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\admin-clinicians.spec.cjs:148:3
...
Call log:
  - waiting for locator('text=Clinician, text=Doctor, text=Staff') to be visible
    ...
    at c:\Users\Peter Darley\Desktop\DEV\BookSmartly\frontend\tests\admin-clinicians.spec.cjs:149:11
```
